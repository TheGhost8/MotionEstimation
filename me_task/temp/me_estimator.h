...
public:
     ...
     * @param[out] MEFielf structure of motion vectorpy::array_t<u_int32t> probabilitiess for frame
     */
    MEField Estimate(
    ...
    /// Error for probable block 16x16 being choosed
    static constexpr int PROB_ERROR_16 = 10000;

    /// Error for probable block 8x8 being choosed
    static constexpr int PROB_ERROR_8 = 4000;
